...
export function buildModelfile(pack, { base = 'llama3.2', name = 'twinbrain' } = {}) {
  ...
  const system = [
    `You are Twin-Brain, the user's personal AI twin: a warm, talkative, brutally honest friend and a gifted teacher. ${POLICY_VERSION}.`,
    '',
  ...
  return [
    `# Twin-Brain personal twin — generated ${new Date().toISOString().slice(0, 10)}`,
